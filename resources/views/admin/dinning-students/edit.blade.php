                                        ...
                                        <div class="admin__thumb-upload">
                                            ...
                                            <div class="admin__thumb-preview">
                                                <div id="image_preview_avatar" class="admin__thumb-profilepreview"
                                                    style="
                            background-image: url({{ $data->avatar != '' ? asset($data->avatar) : asset(avatarUrl()) }});">
                                                </div>
                                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ $data->student_id }}"
                                ...
                                {{-- <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ $data->txid }}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" value="{{ $data->total_meals }}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date"
                                            ...
                                            name="to" placeholder="Select Date" value="{{ $data->to }}"
                                            required>
                                        @error('to')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-md-6">
                                    ...
                                    {{-- <div class="form-group">
                                        ...
                                        <select
                                            ...
                                            <option value="paid" @if ($data->paid_status == 'paid') selected @endif>Paid
                                            </option>

                                            <option value="unpaid" @if ($data->paid_status == 'unpaid') selected @endif>Unpaid
                                            </option>
                                        </select>
                                        @error('paid_status')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select
                                            ...
                                            @foreach (activeModelData('App\Models\Department') as $row)
                                                <option value="{{ $row->id }}"
                                                    @if ($data->department_id == $row->id) selected @endif>{{ $row->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                        @error('department_id')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select
                                            ...
                                            @foreach (activeModelData('App\Models\StudentSession') as $row)
                                                <option value="{{ $row->id }}"
                                                    @if ($data->student_session_id == $row->id) selected @endif>{{ $row->name }}
                                                </option>
                                            @endforeach
                                        </select>
