                            ...
                            @foreach ($data as $row)
                                <tr>
                                    ...
                                    <td><span class="text-dark-75 font-weight-bold d-block font-size-lg">
                                            ...
                                            @if ($row->dinning_date != '')
                                                {{ date('d M Y', strtotime($row->dinning_date)) }}
                                            @else
                                                n/a
                                            @endif
                                    ...
                                    <td>
                                        <div class="form-check form-switch form-switch-md">
                                            <input type="checkbox" name="is_active" value="{{ $row->id }}"
                                                onclick="toggleSwitchStatus(this,'meal_tokens');" class="form-check-input"
                                        ...
                                        <ul class="trk-action__list">
                                            <li class="trk-action">
                                                <a class="trk-action__item trk-action__item--success"
                                                    href="{{ route('admin.meal-tokens.show', $row->id) }}">
                                            ...
                                            @can('meal-token-update')
                                                <li class="trk-action">
                                                    <a class="trk-action__item trk-action__item--warning"
                                                        href="{{ route('admin.meal-tokens.edit', $row->id) }}">
                                                        <i class="lni lni-pencil-alt"></i>
                                                    </a>
                                                </li>
                                            @endcan
                                            @can('meal-token-delete')
                                                <li class="trk-action">
                                                    <a onclick="Delete(`{{ route('admin.meal-tokens.destroy', $row->id) }}`)"
