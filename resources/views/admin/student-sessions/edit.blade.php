        ...
        <div class="col-lg-12">
            ...
            <input 
                type="text" 
                                                                                    ...
                                                                                    value="{{ $data->hsc_session}}" 
                                                                                    class="form-control @error('hsc_session') is-invalid @enderror" 
                id="hsc_session" 
                name="hsc_session" 
    ...
    <div class="form-group">
        ...
        >
            <option value="">--Choose--</option>
                            ...
                            <option value="2019-20" @if($data->name=="2019-20") selected @endif >2019-20</option>
                            
                            <option value="2020-21" @if($data->name=="2020-21") selected @endif >2020-21</option>
                            
                            <option value="2021-22" @if($data->name=="2021-22") selected @endif >2021-22</option>
                            
                            <option value="2022-23" @if($data->name=="2022-23") selected @endif >2022-23</option>
                            
                            <option value="2023-24" @if($data->name=="2023-24") selected @endif >2023-24</option>
                                                                </select>
