...
@section('container')
    <div class="trk-table">
        <div class="trk-table__wrapper">
            ...
            <thead>
                <tr><th>Serial</th><th>Name</th><th>Is Active</th><th>Actions</th></tr>
            </thead>
            <tbody>
        ...
        <input  type="checkbox" name="is_active" value="{{$row->id}}" onclick="toggleSwitchStatus(this,'departments');" class="form-check-input" @if($row->is_active==1) checked @endif>
    </div>
            ...
            <td><ul class="trk-action__list">
                            <li class="trk-action">
                    <a class="trk-action__item trk-action__item--success" href="{{ route('admin.departments.show', $row->id) }}">
                        <i class="lni lni-eye"></i>
                        </a>
                </li>
                                        @can('department-update')
                <li class="trk-action">
                    <a class="trk-action__item trk-action__item--warning" href="{{ route('admin.departments.edit', $row->id) }}">
                ...
                <li class="trk-action">
                    <a onclick="Delete(`{{ route('admin.departments.destroy', $row->id) }}`)"
